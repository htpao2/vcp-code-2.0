			...
			<Select value={JSON.stringify(getProviderPreference(apiConfiguration))} onValueChange={onValueChange}>
				...
				<SelectContent>
					<ProviderSelectItem value={{ type: DEFAULT_VALUE_KEY }}>
						{t("novacode:settings.provider.providerRouting.sorting.default")}
					</ProviderSelectItem>
					<ProviderSelectItem value={{ type: openRouterProviderSortSchema.Values.price }}>
						{t("novacode:settings.provider.providerRouting.sorting.price")}
					</ProviderSelectItem>
					<ProviderSelectItem value={{ type: openRouterProviderSortSchema.Values.throughput }}>
						{t("novacode:settings.provider.providerRouting.sorting.throughput")}
					</ProviderSelectItem>
					<ProviderSelectItem value={{ type: openRouterProviderSortSchema.Values.latency }}>
						{t("novacode:settings.provider.providerRouting.sorting.latency")}
					</ProviderSelectItem>
					<SelectSeparator />
			...
			<Select
				...
				<SelectContent>
					...
					<SelectItem value={openRouterProviderDataCollectionSchema.Values.deny}>
						{t("novacode:settings.provider.providerRouting.dataCollection.deny")}
					</SelectItem>
					<SelectItem value={ZERO_DATA_RETENTION_KEY}>
						{t("novacode:settings.provider.providerRouting.dataCollection.zdr")}
					</SelectItem>
				</SelectContent>
			</Select>
		</div>
