...
describe("InstalledSkillsView", () => {
	...
	it("displays no skills message when skills list is empty", () => {
		...
		expect(screen.getByText("novacode:skills.noSkills")).toBeInTheDocument()
	})
	...
	it("groups skills by source (project and global)", async () => {
		...
		expect(screen.getByText("novacode:skills.projectSkills")).toBeInTheDocument()
		expect(screen.getByText("novacode:skills.globalSkills")).toBeInTheDocument()
	...
	it("opens delete confirmation dialog when delete button is clicked", async () => {
		...
		expect(screen.getByTestId("dialog-title")).toHaveTextContent("novacode:skills.deleteDialog.title")
		// The description contains the skill name via the translation key
		expect(screen.getByTestId("dialog-description")).toHaveTextContent("novacode:skills.deleteDialog.description")
	})
	...
	it("sends removeInstalledMarketplaceItem message when delete is confirmed", async () => {
		...
		const confirmButton = screen.getByText("novacode:skills.deleteDialog.delete")
	...
	it("closes dialog when cancel button is clicked", async () => {
		...
		// Click cancel button
		const cancelButton = screen.getByText("novacode:skills.deleteDialog.cancel")
	...
	it("renders documentation link", () => {
		...
		expect(link).toHaveAttribute("href", "https://nova.ai/docs/features/skills")
	})
	...
	it("only shows project section when there are only project skills", async () => {
		...
		expect(screen.getByText("novacode:skills.projectSkills")).toBeInTheDocument()
		expect(screen.queryByText("novacode:skills.globalSkills")).not.toBeInTheDocument()
	})
	...
	it("only shows global section when there are only global skills", async () => {
		...
		expect(screen.queryByText("novacode:skills.projectSkills")).not.toBeInTheDocument()
		expect(screen.getByText("novacode:skills.globalSkills")).toBeInTheDocument()
	})
