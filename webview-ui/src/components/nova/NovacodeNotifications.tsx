...
export const NovacodeNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "novacodeNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchNovacodeNotifications" })
	}, [])
	...
	return (
		<div className="novacode-notifications flex flex-col mb-4">
