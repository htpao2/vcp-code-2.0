	...
	return (
		<div className="flex flex-col gap-3">
			<div className="flex items-center gap-2">
				...
				<span className="font-semibold text-vscode-foreground">{t("novacode:promotionError.title")}</span>
			</div>
			<p className="text-vscode-descriptionForeground text-sm m-0 break-words">
				{t("novacode:promotionError.message")}
			</p>
			<Button
				variant="primary"
				size="lg"
				...
				{t("novacode:promotionError.signUpButton")}
			</Button>
		</div>
	)
}
