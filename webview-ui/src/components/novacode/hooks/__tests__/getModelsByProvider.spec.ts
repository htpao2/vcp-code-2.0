...
describe("getModelsByProvider", () => {
	...
	const routerModels: RouterModels = {
		apertis: { "test-model": testModel }, // novacode_change
		...
		aihubmix: { "test-model": testModel }, // novacode_change
				...
				(provider) =>
					[
						...
						getModelsByProvider({
							provider,
							routerModels,
							novacodeDefaultModel: "test-default-model",
							options: {},
						}),
