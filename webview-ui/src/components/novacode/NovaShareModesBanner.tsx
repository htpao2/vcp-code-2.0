...
interface NovaShareModesBannerProps {
	className?: string
}

export const NovaShareModesBanner: React.FC<NovaShareModesBannerProps> = ({ className = "" }) => {
	...
	return (
		<a
			...
			<span className="text-sm">
				<span className="font-bold">NEW:</span> {t("novacode:modes.shareModesNewBanner").replace("New: ", "")}
			</span>
		</a>
	)
}
