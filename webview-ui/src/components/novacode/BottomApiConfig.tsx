...
export const BottomApiConfig = () => {
	const { currentApiConfigName, apiConfiguration, virtualQuotaActiveModel } = useExtensionState() // novacode_change: Get virtual quota active model for UI display
	...
	return (
		<>
			{/* novacode_change - add data-testid="model-selector" below */}
			<div className="w-auto overflow-hidden" data-testid="model-selector">
				<ModelSelector
					...
					//novacode_change: Pass virtual quota active model to ModelSelector
