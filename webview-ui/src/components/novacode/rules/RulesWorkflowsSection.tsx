...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "novacode:rules.sections.globalRules" : "novacode:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "novacode:rules.sections.workspaceRules" : "novacode:rules.sections.workspaceWorkflows"
