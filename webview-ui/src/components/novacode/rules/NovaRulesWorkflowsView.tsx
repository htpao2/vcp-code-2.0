...
type NovaRulesWorkflowsViewProps = {
	type: "rule" | "workflow"
}

const NovaRulesWorkflowsView = ({ type }: NovaRulesWorkflowsViewProps) => {
	...
	return (
		<div className="px-5">
			<div className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
				{isRules ? (
					<DescriptionWithLink
						href="https://nova.ai/docs/advanced-usage/custom-rules"
						linkText={t("novacode:docs")}>
						{t("novacode:rules.description.rules")}
					</DescriptionWithLink>
				) : (
					<DescriptionWithLink
						href="https://nova.ai/docs/features/slash-commands/workflows"
						linkText={t("novacode:docs")}>
						{t("novacode:rules.description.workflows")}{" "}
						<span className="text-[var(--vscode-foreground)] font-bold">/workflow-name</span>{" "}
						{t("novacode:rules.description.workflowsInChat")}
					</DescriptionWithLink>
				)}
			</div>
...
export default NovaRulesWorkflowsView
