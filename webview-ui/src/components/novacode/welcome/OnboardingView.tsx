	...
	return (
		<div className="flex flex-col items-center justify-center min-h-screen p-6 bg-vscode-sideBar-background">
			...
			<h1 className="text-2xl font-bold text-vscode-foreground text-center mt-4 mb-10">
				{t("novacode:onboarding.title")}
			</h1>

			<div className="w-full max-w-md flex flex-col gap-4">
				<OnboardingOption
					title={t("novacode:onboarding.freeModels.title")}
					description={t("novacode:onboarding.freeModels.description")}
					icon="sparkle"
					onClick={onSelectFreeModels}
				/>

				<OnboardingOption
					title={t("novacode:onboarding.premiumModels.title")}
					description={t("novacode:onboarding.premiumModels.description")}
					icon="star-full"
					onClick={onSelectPremiumModels}
				/>

				<OnboardingOption
					title={t("novacode:onboarding.byok.title")}
					description={t("novacode:onboarding.byok.description")}
					icon="key"
