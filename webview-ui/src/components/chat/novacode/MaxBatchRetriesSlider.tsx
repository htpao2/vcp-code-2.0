		...
		<div className="space-y-2">
			<div className="flex items-center gap-2">
				<label className="text-sm font-medium">
					{t("novacode:settings.codeIndex.scannerMaxBatchRetriesLabel")}
				</label>
				<StandardTooltip content={t("novacode:settings.codeIndex.scannerMaxBatchRetriesDescription")}>
			...
			<div className="flex items-center gap-2">
				...
				<VSCodeButton
					...
					onClick={() => onChange(CODEBASE_INDEX_DEFAULTS.DEFAULT_SCANNER_MAX_BATCH_RETRIES)}>
