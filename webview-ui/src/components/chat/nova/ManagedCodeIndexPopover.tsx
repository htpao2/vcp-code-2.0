...
const Content = () => {
	...
	const orgId = state.apiConfiguration?.novacodeOrganizationId
	const href = `https://nova.ai/organizations/${orgId}/code-indexing`
			...
			<>
				<div className="p-3 cursor-default">
					...
					<p className="my-0 pr-4 text-sm w-full mb-3">
						<VSCodeLink href={href}>Configure on nova.ai</VSCodeLink>
					</p>
				</div>
