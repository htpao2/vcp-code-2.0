...
import { StandardTooltip } from "../../../components/ui" // novacode_change
import {
	MessageCircle,
...
export function MessageList({ sessionId }: MessageListProps) {
	...
	const { t: tChat } = useTranslation("chat") // novacode_change
	...
	const [isAtBottom, setIsAtBottom] = useState(true) // novacode_change
	...
	const showScrollToBottom = !isAtBottom && allItems.length > 0 // novacode_change
