# Contributing to Nova Code

> **Note**: New versions of the VS Code extension and CLI are being developed in [Nova-Org/Nova](https://github.com/Nova-Org/Nova) (extension at `packages/nova-vscode`, CLI at `packages/opencode`). If you're looking to contribute to the extension or CLI, please head over to that repository.
...
- Star the project
- Post on X or Linkedin about Nova Code `#novacode
...
This project and everyone participating in it is governed by the [Code of Conduct](https://github.com/Nova-Org/novacode/blob/main/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior
to [hi@novacode.ai](mailto:hi@novacode.ai).

## I Have a Question

If you need clarification after reading this document, we encourage you to join our [discord](https://nova.ai/discord) workspace and join channels [nova-dev-contributors](https://discord.com/channels/1349288496988160052/1391109167275577464) and [extensions-support channel](https://discord.com/channels/1349288496988160052/1349358641295265864).

## I Want To Contribute

### Code Contributors

We’re excited that you’re interested in contributing code to Nova Code! Before you start, please take a look at our [Development Guide](https://github.com/Nova-Org/novacode/blob/main/DEVELOPMENT.md), it includes setup instructions, build steps, and details on running tests locally.
...
Unsure if your contribution is “small” or “large”? Start a quick discussion in [nova-dev-contributors](https://discord.com/channels/1349288496988160052/1391109167275577464) channel on discord or open an issue with good context, follow the commit and pull request guidelines below once you’re ready to open a PR.

### Reporting Bugs

Please use our issues templates that provide hints on what information we need to help you.

> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to [hi@novacode.ai](mailto:hi@novacode.ai).

### Custom Modes

Custom modes are a powerful way to extend Nova Code's capabilities. To create and share a custom mode:

- Follow the [Custom Modes documentation](https://nova.ai/docs/customize/custom-modes) to create your mode.

- Test your mode thoroughly

- Share your mode with the community on [Reddit](https://www.reddit.com/r/novacode/) or you can show off / start a discussion on [show-off-your-builds](https://discord.com/channels/1349288496988160052/1375399779760214037) or [workflows-and-integration](https://discord.com/channels/1349288496988160052/1420236932780130418) on discord.

### Feature Requests

Suggest feature requests in [Discussion](https://github.com/Nova-Org/novacode/discussions), only open an [Issue](https://github.com/Nova-Org/novacode/issues/new/choose) for reporting a bug or actual contributions. Don't open issues for questions or support, instead join our [Discord workspace](https://nova.ai/discord) and ask there.
...
Please note that the main [documentation](https://github.com/Nova-Org/docs) repository has been archived, you can still view it for reference.
...
- Open a Pull Request against the main Nova Code repository.
...
For more context, kindly read the official [contributing docs](https://nova.ai/docs/contributing).

Your contributions, big or small help make Nova Code better for everyone!🫶
