<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=novacode.Nova-Code"><img src="https://img.shields.io/badge/VS_Code_Marketplace-007ACC?style=flat&logo=visualstudiocode&logoColor=white" alt="VS Code Marketplace"></a>
  ...
  <a href="https://blog.nova.ai"><img src="https://img.shields.io/badge/Blog-555?style=flat&logo=substack&logoColor=white" alt="Substack Blog"></a>
  <a href="https://nova.ai/discord"><img src="https://img.shields.io/badge/Join%20Discord-5865F2?style=flat&logo=discord&logoColor=white" alt="Discord"></a>
...
> Nova is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
...
<p align="center">
  <img src="https://media.githubusercontent.com/media/Nova-Org/novacode/main/nova.gif" width="100%" />
</p>

## Quick Links

- [VS Code Marketplace](https://nova.ai/vscode-marketplace?utm_source=Readme) (download)
- [Official Nova.ai Home page](https://nova.ai) (learn more)

## Key Features

- **Code Generation:** Nova can generate code using natural language.
- **Inline Autocomplete:** Get intelligent code completions as you type, powered by AI.
- **Task Automation:** Nova can automate repetitive coding tasks to save time..
- **Automated Refactoring:** Nova can refactor and improve existing code efficiently.
- **MCP Server Marketplace**: Nova can easily find, and use MCP servers to extend the agent capabilities.
- **Multi Mode**: Plan with Architect, Code with Coder, and Debug with Debugger, and make your own custom modes.

## Get Started

1. Install the Nova Code extension from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=novacode.Nova-Code).
...
3. Start coding with AI that adapts to your workflow. Watch our quick-start guide to see Nova in action:
...
Contributions are welcome, and they are greatly appreciated! Get started by reading our [Contributing Guide](CONTRIBUTING.md). Or join our [Discord](https://nova.ai/discord) to chat with the team and community.

Thanks to all the contributors who help make Nova better!
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/Nova-Org/novacode/graphs/contributors">
        <b>more ...</b>
      </a>
    </td>
  </tr>
