...
package ai.novacode.jetbrains.util
...
class ReflectUtilsStatusBarTest {
    ...
    fun `test setEntry with Double priority from JSON`() = runBlocking {
        ...
        val args = listOf(
            ...
            "test-entry",           // entryId
            "Test Name",            // name
            "Autocompletions provided by mistralai/codestral-2508 via Nova Gateway.", // text
            null,                   // tooltip
            false,                  // showProgress
            null,                   // command
    ...
    fun `test setEntry with MarkdownString-like tooltip object`() = runBlocking {
        ...
        val markdownTooltip = mapOf(
            "value" to "Autocompletions provided by mistralai/codestral-2508 via Nova Gateway.",
            "isTrusted" to true,
