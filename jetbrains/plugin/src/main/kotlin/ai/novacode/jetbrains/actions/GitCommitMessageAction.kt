package ai.novacode.jetbrains.actions

import ai.novacode.jetbrains.git.CommitMessageService
import ai.novacode.jetbrains.git.WorkspaceResolver
import ai.novacode.jetbrains.git.FileDiscoveryService
import ai.novacode.jetbrains.i18n.I18n
...
class GitCommitMessageAction : AnAction(I18n.t("novacode:commitMessage.ui.generateButton")) {
    ...
    override fun update(e: AnActionEvent) {
        ...
        if (project == null) {
            ...
            presentation.description = I18n.t("novacode:commitMessage.errors.noProject")
            return
        }
        ...
        presentation.description = if (hasAnyChanges) {
            I18n.t("novacode:commitMessage.ui.generateButtonTooltip")
        } else {
            I18n.t("novacode:commitMessage.errors.noChanges")
        }
    }
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val workspacePath = WorkspaceResolver.getWorkspacePathOrShowError(
            project,
            I18n.t("novacode:commitMessage.errors.noWorkspacePath"),
            I18n.t("novacode:commitMessage.dialogs.error"),
        ) ?: return
    ...
    private fun generateAndSetCommitMessage(
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(
            project,
            I18n.t("novacode:commitMessage.progress.title"),
            true,
        ) {
            override fun run(indicator: ProgressIndicator) {
                indicator.text = I18n.t("novacode:commitMessage.progress.analyzing")
                ...
                try {
                    ...
                    indicator.text = I18n.t("novacode:commitMessage.progress.generating")
                    ...
                    ApplicationManager.getApplication().invokeLater {
                        Messages.showErrorDialog(
                            project,
                            I18n.t("novacode:commitMessage.errors.processingError",
                                mapOf("error" to (e.message ?: I18n.t("novacode:commitMessage.error.unknown")))),
                            I18n.t("novacode:commitMessage.dialogs.error"),
                        )
                    }
                }
    ...
    companion object {
        val PENDING_COMMIT_MESSAGE_KEY = com.intellij.openapi.util.Key.create<String>("NOVACODE_PENDING_COMMIT_MESSAGE")
    }
}
