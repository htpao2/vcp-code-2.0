 ...
 * contextManager.setContext("novacode.autocomplete.enableQuickInlineTaskKeybinding", true)
 * val value = contextManager.getContext("novacode.autocomplete.enableQuickInlineTaskKeybinding")
 * ```
 */
...
class ContextManager {
     ...
     * 
     * @param key The context key (e.g., "novacode.autocomplete.enableQuickInlineTaskKeybinding")
