...
object InlineCompletionConstants {
     ...
     */
    const val EXTERNAL_COMMAND_ID = "nova-code.jetbrains.getInlineCompletions"
     ...
     */
    const val INLINE_COMPLETION_ACCEPTED_COMMAND = "novacode.autocomplete.inline-completion.accepted"
