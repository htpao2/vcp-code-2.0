...
import ai.novacode.jetbrains.editor.EditorAndDocManager
import ai.novacode.jetbrains.ipc.NodeSocket
import ai.novacode.jetbrains.ipc.PersistentProtocol
import ai.novacode.jetbrains.ipc.proxy.ResponsiveState
import ai.novacode.jetbrains.util.MachineIdUtil
    ...
    private fun createInitData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "environment" to mapOf(
                ...
                "globalStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"), ".novacode", "globalStorage").toString()),
                "workspaceStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"), ".novacode", "workspaceStorage").toString()),
