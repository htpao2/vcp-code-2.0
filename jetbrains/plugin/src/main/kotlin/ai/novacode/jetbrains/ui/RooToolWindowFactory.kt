package ai.novacode.jetbrains.ui

import ai.novacode.jetbrains.actions.OpenDevToolsAction
import ai.novacode.jetbrains.core.PluginContext
import ai.novacode.jetbrains.plugin.DebugMode
import ai.novacode.jetbrains.plugin.WecoderPlugin
import ai.novacode.jetbrains.plugin.WecoderPluginService
import ai.novacode.jetbrains.util.NodeVersionUtil
import ai.novacode.jetbrains.util.PluginConstants
import ai.novacode.jetbrains.webview.DragDropHandler
import ai.novacode.jetbrains.webview.WebViewCreationCallback
import ai.novacode.jetbrains.webview.WebViewInstance
...
class RooToolWindowFactory : ToolWindowFactory {
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            // Get Node.js version
            val nodeVersion = try {
                val nodePath = ai.novacode.jetbrains.util.PluginResourceUtil.getResourcePath(
            ...
            return buildString {
                ...
                append("<h3>Nova Code Initialization</h3>")
                ...
                if (!jcefSupported) {
                    ...
                    append("<a href='https://nova.ai/docs/jetbrains-troubleshooting' target='_blank' style='color: #721c24; text-decoration: underline;'>See JetBrains docs for how to enable JCEF in your IDE</a>")
                    append("</div>")
                    append("<br>")
                }
        ...
        private fun createSystemInfoPlainText(): String {
            ...
            return buildString {
                append("Nova Code Initialization\n")
                append("========================\n")
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://nova.ai/docs")
            }
        }
