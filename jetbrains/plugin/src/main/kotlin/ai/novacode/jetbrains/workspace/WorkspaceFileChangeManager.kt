...
package ai.novacode.jetbrains.workspace

import ai.novacode.jetbrains.core.PluginContext
import ai.novacode.jetbrains.core.ServiceProxyRegistry
import ai.novacode.jetbrains.core.WorkspaceManager
import ai.novacode.jetbrains.events.FileChangeType
import ai.novacode.jetbrains.events.ProjectEventBus
import ai.novacode.jetbrains.events.WorkspaceDirectoriesChangeEvent
import ai.novacode.jetbrains.events.WorkspaceDirectoryChangeEvent
import ai.novacode.jetbrains.events.WorkspaceFileChangeData
import ai.novacode.jetbrains.events.WorkspaceFileChangeEvent
import ai.novacode.jetbrains.events.WorkspaceFilesChangeData
import ai.novacode.jetbrains.events.WorkspaceFilesChangeEvent
import ai.novacode.jetbrains.events.WorkspaceRootChangeData
import ai.novacode.jetbrains.events.WorkspaceRootChangeEvent
import ai.novacode.jetbrains.ipc.proxy.interfaces.FileSystemEvents
