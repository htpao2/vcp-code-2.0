...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.promptsButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.profileButtonClicked"
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "nova-code.marketplaceButtonClicked"
 ...
 */
class OpenDevToolsAction(private val getWebViewInstance: () -> ai.novacode.jetbrains.webview.WebViewInstance?) : AnAction("Open Developer Tools") {
