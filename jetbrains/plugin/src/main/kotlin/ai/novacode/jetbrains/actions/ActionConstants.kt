...
object CommandIds {
    ...
    const val EXPLAIN = "nova-code.explainCode"

    /** Command ID for fixing code */
    const val FIX = "nova-code.fixCode"

    /** Command ID for improving code */
    const val IMPROVE = "nova-code.improveCode"

    /** Command ID for adding to context */
    const val ADD_TO_CONTEXT = "nova-code.addToContext"

    /** Command ID for creating a new task */
    const val NEW_TASK = "nova-code.newTask"
}
