...
import ai.novacode.jetbrains.util.NodeVersion
import ai.novacode.jetbrains.util.NodeVersionUtil
import ai.novacode.jetbrains.util.NotificationUtil
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = ai.novacode.jetbrains.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
