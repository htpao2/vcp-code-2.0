package ai.novacode.jetbrains.inline
 ...
 */
class NovaCodeInlineCompletionProvider(
    ...
    private val logger = Logger.getInstance(NovaCodeInlineCompletionProvider::class.java)
     ...
     */
    override val insertHandler = NovaCodeInlineCompletionInsertHandler(project)

    /**
     * Unique identifier for this provider.
     * Required by InlineCompletionProvider interface.
     */
    override val id: InlineCompletionProviderID = InlineCompletionProviderID("novacode-inline-completion-$extensionId-$handle")
