...
package ai.novacode.jetbrains.git

import ai.novacode.jetbrains.actions.GitCommitMessageAction
...
class CommitMessageHandler(
    ...
    private inner class CommitMessageConfigPanel : RefreshableOnComponent {
        ...
        init {
            generateButton = JButton(I18n.t("novacode:commitMessage.ui.generateButton")).apply {
                addActionListener {
                    generateCommitMessage()
                }
                toolTipText = I18n.t("novacode:commitMessage.ui.generateButtonTooltip")
            }
    ...
    private fun generateCommitMessage() {
        ...
        val workspacePath = WorkspaceResolver.getWorkspacePathOrShowError(
            project,
            I18n.t("novacode:commitMessage.error.workspacePathNotFound"),
            I18n.t("novacode:commitMessage.error.title"),
        ) ?: return
                ...
                try {
                    ...
                    ApplicationManager.getApplication().invokeLater {
                        ...
                        Messages.showErrorDialog(
                            project,
                            I18n.t("novacode:commitMessage.error.generationFailed", mapOf("error" to (e.message ?: I18n.t("novacode:commitMessage.error.unknown")))),
                            I18n.t("novacode:commitMessage.error.title"),
                        )
                    }
                }
    ...
    private fun executeCommitMessageGeneration(
        ...
        try {
            indicator.text = I18n.t("novacode:commitMessage.progress.connecting")
            ...
            ApplicationManager.getApplication().invokeLater({
                ...
                Messages.showErrorDialog(
                    project,
                    I18n.t("novacode:commitMessage.error.processingFailed", mapOf("error" to (e.message ?: I18n.t("novacode:commitMessage.error.unknown")))),
                    I18n.t("novacode:commitMessage.error.title"),
                )
            }, ModalityState.defaultModalityState())
        }
