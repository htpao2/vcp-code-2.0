...
import ai.novacode.jetbrains.actors.MainThreadBulkEditsShape
import ai.novacode.jetbrains.actors.MainThreadClipboardShape
import ai.novacode.jetbrains.actors.MainThreadCommandsShape
import ai.novacode.jetbrains.actors.MainThreadConfigurationShape
import ai.novacode.jetbrains.actors.MainThreadConsoleShape
import ai.novacode.jetbrains.actors.MainThreadDebugServiceShape
import ai.novacode.jetbrains.actors.MainThreadDiaglogsShape
import ai.novacode.jetbrains.actors.MainThreadDocumentContentProvidersShape
import ai.novacode.jetbrains.actors.MainThreadDocumentsShape
import ai.novacode.jetbrains.actors.MainThreadEditorTabsShape
import ai.novacode.jetbrains.actors.MainThreadErrorsShape
import ai.novacode.jetbrains.actors.MainThreadExtensionServiceShape
import ai.novacode.jetbrains.actors.MainThreadFileSystemEventServiceShape
import ai.novacode.jetbrains.actors.MainThreadFileSystemShape
import ai.novacode.jetbrains.actors.MainThreadLanguageFeaturesShape
import ai.novacode.jetbrains.actors.MainThreadLanguageModelToolsShape
import ai.novacode.jetbrains.actors.MainThreadLoggerShape
import ai.novacode.jetbrains.actors.MainThreadMessageServiceShape
import ai.novacode.jetbrains.actors.MainThreadOutputServiceShape
import ai.novacode.jetbrains.actors.MainThreadSearchShape
import ai.novacode.jetbrains.actors.MainThreadSecretStateShape
import ai.novacode.jetbrains.actors.MainThreadStatusBarShape
import ai.novacode.jetbrains.actors.MainThreadStorageShape
import ai.novacode.jetbrains.actors.MainThreadTaskShape
import ai.novacode.jetbrains.actors.MainThreadTelemetryShape
import ai.novacode.jetbrains.actors.MainThreadTerminalServiceShape
import ai.novacode.jetbrains.actors.MainThreadTerminalShellIntegrationShape
import ai.novacode.jetbrains.actors.MainThreadTextEditorsShape
import ai.novacode.jetbrains.actors.MainThreadUrlsShape
import ai.novacode.jetbrains.actors.MainThreadWebviewViewsShape
import ai.novacode.jetbrains.actors.MainThreadWebviewsShape
import ai.novacode.jetbrains.actors.MainThreadWindowShape
import ai.novacode.jetbrains.ipc.proxy.createProxyIdentifier
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostCommandsProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostConfigurationProxy
...
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostExtensionServiceProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostFileSystemEventServiceProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalServiceProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewViewsProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewsProxy
import ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWorkspaceProxy
...
//
    ...
    object ExtHostContext {
        ...
        val ExtHostCommands = createProxyIdentifier<ExtHostCommandsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostCommandsProxy")
        val ExtHostConfiguration = createProxyIdentifier<ExtHostConfigurationProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostConfigurationProxy")
        ...
        val ExtHostDocumentsAndEditors = createProxyIdentifier<ExtHostDocumentsAndEditorsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsAndEditorsProxy")
        val ExtHostDocuments = createProxyIdentifier<ExtHostDocumentsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsProxy")
        ...
        val ExtHostEditors = createProxyIdentifier<ExtHostEditorsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostEditorsProxy")
        ...
        val ExtHostFileSystemEventService = createProxyIdentifier<ExtHostFileSystemEventServiceProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostFileSystemEventServiceProxy")
        ...
        val ExtHostExtensionService = createProxyIdentifier<ExtHostExtensionServiceProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostExtensionServiceProxy")
        val ExtHostLogLevelServiceShape = createProxyIdentifier<Any>("ExtHostLogLevelServiceShape")
        val ExtHostTerminalService = createProxyIdentifier<ExtHostTerminalServiceProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalServiceProxy")
        val ExtHostTerminalShellIntegration = createProxyIdentifier<ExtHostTerminalShellIntegrationProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy")
        ...
        val ExtHostWorkspace = createProxyIdentifier<ExtHostWorkspaceProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWorkspaceProxy")
        val ExtHostWindow = createProxyIdentifier<Any>("ExtHostWindow")
        val ExtHostWebviews = createProxyIdentifier<ExtHostWebviewsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewsProxy")
        ...
        val ExtHostWebviewViews = createProxyIdentifier<ExtHostWebviewViewsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostWebviewViewsProxy")
        val ExtHostEditorInsets = createProxyIdentifier<Any>("ExtHostEditorInsets")
        val ExtHostEditorTabs = createProxyIdentifier<ExtHostEditorTabsProxy>("ai.novacode.jetbrains.ipc.proxy.interfaces.ExtHostEditorTabsProxy")
