...
import ai.novacode.jetbrains.core.ContextManager
 ...
 * - novacode.autocomplete.enableQuickInlineTaskKeybinding
...
class SetContextCommands(val project: Project) {
     ...
     * 
     * @param key The context key to set (e.g., "novacode.autocomplete.enableQuickInlineTaskKeybinding")
