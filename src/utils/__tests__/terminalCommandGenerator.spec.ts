...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			"novacode:terminalCommandGenerator.inputPrompt": "Nova: Describe the command you want to generate",
			"novacode:terminalCommandGenerator.inputPlaceholder":
				"e.g., kill the process running on port 3001, find large files, etc",
			"novacode:terminalCommandGenerator.noActiveTerminal":
				"No active terminal found. Please open a terminal first.",
			"novacode:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"novacode:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"novacode:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"novacode:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"novacode:terminalCommandGenerator.warningDialog.message":
			...
			"novacode:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"novacode:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}
...
describe("generateTerminalCommand", () => {
	...
	it("should generate and place terminal command without executing", async () => {
		...
		expect(vscode.window.showInputBox).toHaveBeenCalledWith({
			prompt: "Nova: Describe the command you want to generate",
