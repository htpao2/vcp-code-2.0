...
const METHOD_CAPTURE = ["definition.method", "definition.method.start"] // novacode_change
...
function processCaptures(captures: QueryCapture[], lines: string[], language: string): string | null {
	...
	captures.forEach((capture) => {
		...
		if (shouldSkipMinLines(lineCount, capture, language) /*novacode_change: orginal logic moved into function*/) {
			return
		}
