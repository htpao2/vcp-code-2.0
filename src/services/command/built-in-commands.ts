...
const BUILT_IN_COMMANDS: Record<string, BuiltInCommandDefinition> = {
	// novacode_change start - Modified all .roo references to .novacode for Nova Code fork
	init: {
		name: "init",
  ...
  <todo_list_creation>
    If the update_todo_list tool is available, create a todo list with these focused analysis steps:
     ...
     1. Check for existing AGENTS.md files
       ...
       - .novacode/rules-code/AGENTS.md (relative to project root)
       - .novacode/rules-debug/AGENTS.md (relative to project root)
       - .novacode/rules-ask/AGENTS.md (relative to project root)
       - .novacode/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       - If files exist: AGGRESSIVELY clean them up
        ...
        - Create mode-specific files in .novacode/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .novacode folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .novacode/rules-code/AGENTS.md (create .novacode in project root, not system root!)
    - .novacode/rules-debug/AGENTS.md (relative to project root)
    - .novacode/rules-ask/AGENTS.md (relative to project root)
    - .novacode/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .novacode directory must be created in the current project/workspace root directory,
    ...
    ├── .novacode/                   # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .novacode/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .novacode/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .novacode/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .novacode/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
