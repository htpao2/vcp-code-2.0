...
export const EXPERIMENT_IDS = {
	MORPH_FAST_APPLY: "morphFastApply", // novacode_change
	SPEECH_TO_TEXT: "speechToText", // novacode_change
...
export const experimentConfigsMap: Record<ExperimentKey, ExperimentConfig> = {
	MORPH_FAST_APPLY: { enabled: false }, // novacode_change
	SPEECH_TO_TEXT: { enabled: true }, // novacode_change
