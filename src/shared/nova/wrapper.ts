export interface NovaCodeWrapperProperties {
	...
	novaCodeWrapper: string | null
	novaCodeWrapperTitle: string | null
	novaCodeWrapperCode: string | null
	novaCodeWrapperVersion: string | null
	novaCodeWrapperJetbrains: boolean
