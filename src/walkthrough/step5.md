...
Click the magic wand icon to make your prompt clearer and more complete. Nova Code will rewrite it to get better results.

# Add files or folders for context

Mention files or folders in your prompt. Nova Code will use them to better understand and respond to your request.
