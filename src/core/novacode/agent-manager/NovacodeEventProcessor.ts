import type { NovacodeStreamEvent, NovacodePayload } from "./CliOutputParser"
...
export class NovacodeEventProcessor {
	...
	private readonly onPaymentRequiredPrompt?: (payload: NovacodePayload) => void
	...
	public handle(sessionId: string, event: NovacodeStreamEvent): void {
	 ...
	 */
	private sendStateEventForMessage(sessionId: string, payload: NovacodePayload): void {
	...
	private deriveMessageText(payload: NovacodePayload, checkpoint?: Record<string, unknown>): string {
