...
export class SetupScriptService {
	...
	constructor(projectRoot: string) {
		...
		this.scriptPath = path.join(projectRoot, NOVACODE_DIR, SETUP_SCRIPT_FILENAME)
	}
	...
	async createDefaultScript(): Promise<void> {
		// Ensure .novacode directory exists
		const novacodeDir = path.join(this.projectRoot, NOVACODE_DIR)
